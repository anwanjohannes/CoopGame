...
#File aims at offering tests for functions handling (create bit matrix / extract needed pieces of informationa) bit matrix for a number of players n and optional a game vector A specified.
#First Section tests for createBitMatrix (Check 21.1-21.5)
#Second section tests for
# -getPlayersFromBitVector (Check 21.6)
# -getPlayersFromBMRow (Check 21.7)
#Third section general test (Check 21.8)
