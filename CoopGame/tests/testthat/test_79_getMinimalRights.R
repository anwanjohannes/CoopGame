...
test_that("Check 79.10 - getMinimalRights - 4 players",{
  ...
  A <- c(2,5,2,5,7,7,7,7,7,7,12,12,12,12,22) 
  result = getMinimalRights(A)
...
test_that("Check 79.11 - getMinimalRights - 4 players",{
  ...
  A <- c(2,5,2,5,7,7,7,7,7,7,10,11,12,13,22) 
  result = getMinimalRights(A)
...
test_that("Check 79.12 - getMinimalRights - 4 players",{
  ...
  A <- c(2,5,2,5,7,8,7,9,7,5,10,11,12,13,22) 
  result = getMinimalRights(A)
  expect_equal(result, c(2,5,2,5))
})
...
test_that("Check 79.13 - getMinimalRights - 4 players",{
  ...
  A <- c(0,0,0,0,6,8,7,9,7,5,10,11,12,13,22) 
  result = getMinimalRights(A)
  expect_equal(result, c(0,0,0,0))
})
...
test_that("Check 79.14 - getMinimalRights - 5 players",{
  ...
  A <- c(0, 0, 0, 0, 0, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72) 
  result = getMinimalRights(A)
...
test_that("Check 79.15 - getMinimalRights - 5 players",{
  ...
  A <- c(73, 0, 72, 74, 75, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 72, 80) 
  result = getMinimalRights(A)
