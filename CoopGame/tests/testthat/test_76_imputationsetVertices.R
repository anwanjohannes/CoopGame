...
test_that("Check 76.1 - imputationsetVertices - 3 players",{
  if(boolSkip){
  ...
  V2 <- c(2, 17, 5)
  V3 <- c(2, 4, 18)
  result = imputationsetVertices(A)
  expect_equal(result[1, ], V1)
  expect_equal(result[2, ], V2)
  expect_equal(result[3, ], V3)
})

test_that("Check 76.2 - imputationsetVertices - 3 players",{
  if(boolSkip){
    skip("Test was skipped")
  }
  ...
  V3 <- c(0, 0, 100)
  result = imputationsetVertices(A)
  expect_equal(result[1, ], V3)
  expect_equal(result[2, ], V2)
  expect_equal(result[3, ], V1)
})

test_that("Check 76.3 - imputationsetVertices - 4 players",{
  if(boolSkip){
    skip("Test was skipped")
  }
...
test_that("Check 76.4 - imputationsetVertices - 4 players",{
  if(boolSkip){
    skip("Test was skipped")
  }
...
test_that("Check 76.5 - imputationsetVertices - 5 players",{
  if(boolSkip){
    skip("Test was skipped")
  }
